...
class MDXRequestHandler:
    ...
    def filter_by_language(self, results: list[dict], language: str) -> list:
        return [
    ...
    def get_chapters(self, manga_id: str, language: str) -> list[dict[str, str | None]]:
        ...
        while True:
            try:
                ...
                self._manga_chapters.extend(page)
                offset += limit
    ...
    def get_page_metadata(self, chapter_id: str) -> list[str] | None:
        ...
        for attempt in range(3):
            ...
            # Retry with exponential backoff if request fails, up to 3 attempts
            except requests.exceptions.RequestException as e:
